...
class PeminjamanBuku extends BaseController
{
    ...
    public function delete($id)
    {
        ...
        //select data peminjaman_buku based on id
        $peminjaman_buku =  $this->PeminjamanBukuModel->where('id', $id)->first();
        $buku_id = $peminjaman_buku['buku_id'];
        $peminjaman_id = $peminjaman_buku['peminjaman_id'];

        //delete peminjaman buku
        $this->PeminjamanBukuModel->delete($id);
